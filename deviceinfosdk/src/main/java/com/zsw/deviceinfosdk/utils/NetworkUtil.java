...
public class NetworkUtil {
    ...
    public static boolean networkAvaliable() {
        try {
            final ConnectivityManager manager = (ConnectivityManager) DeviceInfoSDK.getInstance().getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isWifi() {
        try {
            WifiManager wm = (WifiManager) DeviceInfoSDK.getInstance().getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
    ...
    public static String getCurrentNetType(String defaultType) {
        ...
        ConnectivityManager cm = (ConnectivityManager) DeviceInfoSDK.getInstance().getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getMacAddressBelowVersionM() {
        WifiManager wifi = (WifiManager) DeviceInfoSDK.getInstance().getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        if (wifi == null) {
            return DEFAULT_MAC;
        }
        try {
